...
TRUNCATE TABLE `x-marketing.sandler_network.db_all_hubspot_leads`;

INSERT INTO `x-marketing.sandler_network.db_all_hubspot_leads` (
  contact_id,
  active_opp_network_contact_status_portal_ids,
  age,
  became_customer_date,
  became_lead_date,
  became_mql_date,
  became_sql_date,
  became_subscriber_date,
  became_evangelist_date,
  became_opportunity_date,
  became_other_date,
  became_customer_in_assigned_franchise_portal,
  became_network_contact_date,
  city,
  company_id,
  company,
  contact_owner,
  ...
  country,
  created_date,
  cumulative_time_in_lead,
  cumulative_time_in_mql,
  current_assigned_nbc_franchise_business_name,
  current_assigned_nbc_franchise_poc_email,
  current_assigned_nbc_franchise_poc_name,
  current_assigned_nbc_franchise_portal_id,
  current_assigned_nbc_franchise_shortcode_id,
  currently_active_opp_in_assigned_franchise_portal,
  currently_in_sequence,
  currently_in_workflow,
  customer_network_contact_status_portal_ids,
  desired_franchise_city,
  desired_franchise_location_zip_code,
  desired_franchise_state,
  desired_franchise_zip_code,
  ead_contact,
  email,
  email_domain,
  enterprise_contact_status,
  first_conversion,
  first_conversion_date,
  first_name,
  first_nbc_lead_assigned_date,
  first_touch_converting_campaign,
  industry,
  job_function,
  job_title,
  last_activity_date,
  ...
  last_modified_date,
  last_name,
  last_sequence_ended_date,
  last_sequence_enrolled,
  last_sequence_enrolled_date,
  latest_nbc_lead_assigned_date,
  latest_source,
  latest_source_date,
  ...
  latest_time_in_lead,
  latest_time_in_mql,
  lead_network_contact_status_portal_ids,
  lead_assignment_last_sync_to_franchise_portal_date,
  lead_assignment_sync_to_network,
  lead_status,
  left_company,
  lifecycle_stage,
  lms_all_franchise_hs_portal_ids,
  marketing_contact_status,
  marketing_contact_status_source_name,
  marketing_contact_status_source_type,
  marketing_lead_source,
  mobile_phone,
  nbc_assignment_all_franchise_hs_portal_ids,
  split_nbc_assignment_all_franchise_hs_portal_ids,
  _franchise_index,
  nbc_campaign_recent_mql_qualifying_event,
  network_contact_status,
  network_contact_status_first_became_lead_date,
  network_contact_status_last_became_lead_date,
  new_lms_user_status,
  new_lms_parent_org_type,
  next_activity_date,
  number_of_form_submissions,
  number_of_nbc_lead_assignemnts,
  organization_size,
  orginal_source,
  orginal_source_drill_down_1,
  orginal_source_drill_down_2,
  owner_assigned_date,
  persona,
  phone_number,
  postal_code,
  prospective_owner_description,
  ready_for_franchisee_lead_assignment_lookups,
  ready_for_lead_assignment_notifications,
  recent_app_assigned_nbc_shortcode_id,
  recent_enterprise_conversion_name,
  recent_enterprise_eligible_conversion_date,
  record_id,
  rejected_nbc_lead_reason_sandler,
  send_to_sandler_rotator_app,
  state_picklist,
  state,
  street_address,
  utm_campaign,
  ...
  company_cmp,
  country_cmp,
  franchise_child_hs_portal_id,
  franchise_eligible_for_lead_distribution,
  marketing_code,
  nbc_lead_assignment_referral_poc_email,
  nbc_lead_assignment_referral_poc_name,
  postal_code_cmp,
  state_cmp,
  status_date,
  status
