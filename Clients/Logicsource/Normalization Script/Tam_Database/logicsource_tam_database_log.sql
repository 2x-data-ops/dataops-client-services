...
WITH 
  contact_details AS (
    SELECT 
          ...
          CASE WHEN property_management_level__organic_.value IS NOT NULL THEN property_management_level__organic_.value ELSE property_management_level.value END _seniority,
          ...
          '' AS _persona,
          CASE WHEN property_lifecyclestage.value = "177399578" THEN 'N/A'
          ...
          ELSE
          property_lifecyclestage.value END AS _lifecycleStage,
