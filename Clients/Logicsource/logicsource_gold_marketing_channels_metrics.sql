 ...
 */
--  CREATE OR REPLACE TABLE `x-marketing.logicsource.dashboard_marketing_channels_metrics` AS
TRUNCATE TABLE  `x-marketing.logicsource.dashboard_marketing_channels_metrics`;

INSERT INTO `x-marketing.logicsource.dashboard_marketing_channels_metrics` (
  _campaignID,
  _campaign,
  _sent_timestamp,
  _channel,
