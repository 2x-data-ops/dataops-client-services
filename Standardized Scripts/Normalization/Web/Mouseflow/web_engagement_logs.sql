...
/* 
  This script is used for web related engagements
  CRM/Platform/Tools: Mouseflow, 6Sense 6Signal
  Data type: Web Engagement
  Depedency Table: dashboard
  Target table: db_web_engagements_log
*/

TRUNCATE TABLE `x-marketing.sandler.db_web_engagements_log`;

INSERT INTO `x-marketing.sandler.db_web_engagements_log`
WITH
    mouseflow AS (
        SELECT 
            DISTINCT _recordingurl,
            _recordingid,
            _visitorid,
            ...
            _country
        FROM 
            `x-marketing.sandler_mysql.mouseflow_pageviews` main
